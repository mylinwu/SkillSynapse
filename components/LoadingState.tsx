...
const LoadingState: React.FC<LoadingStateProps> = ({ skillName }) => {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full">
       ...
       <h2 className="text-xl font-medium text-stone-800 dark:text-stone-200 tracking-tight">正在深入分析...</h2>
       <p className="mt-3 text-stone-500 text-sm font-light">获取上下文信息并生成技术报告</p>
       {skillName && (
