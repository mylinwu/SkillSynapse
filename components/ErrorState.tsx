...
const ErrorState: React.FC<ErrorStateProps> = ({ message, onClose }) => {
	return (
		<div className="flex flex-col items-center justify-center h-full w-full text-stone-400">
			...
			<h2 className="text-lg font-medium mb-2 text-stone-800 dark:text-stone-200">
				分析失败
			</h2>
			<p className="text-center max-w-md text-sm mb-6 text-stone-500 dark:text-stone-400">
				{message}
			</p>
			<button
				onClick={onClose}
